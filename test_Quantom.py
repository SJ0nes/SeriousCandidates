...
def test_calculate_wave_speed():
    ...
    assert Quantom.calculate_wave_speed(wavelength=1,frequency=2, time=3) == None, "the function should return None when 2 parameters are not inputted"#testing when too many parameters are entered
    ...
    assert Quantom.calculate_wave_speed(wavelength = 2, time =(-1)) == None, "the function should return None when time is negative"#testing when time negative
...
def test_calculate_photon_energy():
    ...
    assert Quantom.calculate_photon_energy(time=2) == 3.313e-34, "the function should return 3.313e-34"#testing with only time inputted
